  ...
  return (
    <div className="manga-card-v2" style={{ width: "100%" }}>
      <div className="card-image-wrap">
        <Image src={coverUrl} alt={title} fill className="card-img" />
  ...
  const libraryData = [
    {
      title: "SOLO LEVELING",
      coverUrl:
        "https://uploads.mangadex.org/covers/32d76d19-8a05-4d29-9ef9-af39ca7a1cb6/6027a3c3-d9d1-447a-8531-1e9671d18f8e.jpg",
      status: "Reading",
      progress: 124,
    },
    {
      title: "ONE PIECE",
      coverUrl:
        "https://uploads.mangadex.org/covers/a1c1105e-f089-4b6c-9419-f9c264a4d651/7f23c965-6490-410a-810a-e3743521d966.jpg",
      status: "Reading",
      progress: 1105,
    },
    {
      title: "BERSERK",
      coverUrl:
        "https://uploads.mangadex.org/covers/80151fe1-4a87-4d92-938b-d748f22036c6/e562164c-f06b-4e11-82c5-3a059d4f05fa.jpg",
      status: "Completed",
      progress: 375,
    },
    {
      title: "VAGABOND",
      coverUrl:
        "https://uploads.mangadex.org/covers/d8f9e61c-5296-485a-8d69-2f22384a2-3f8/77d54e5a-2735-4202-a160-5f284e369b76.jpg",
      status: "On Hold",
      progress: 327,
    },
  ];
        ...
        {libraryData.length === 0 && (
          ...
          >
            ...
            <p style={{ color: "var(--text-dim)", marginBottom: "32px" }}>
              Start your journey by adding some titles to your collection.
            </p>
            <Link href="/" className="btn-premium btn-fill">
              EXPLORE TRENDS
            </Link>
          </div>
        )}
