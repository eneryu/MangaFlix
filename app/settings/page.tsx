            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {language === 'ar' ? 'إشعارات عند إضافة مانجا جديدة' : 'Notifications when new manga is added'}
                  </p>
                </div>
                <Switch
                  id="notifyNewManga"
                  checked={settings.notifyNewManga}
                  onCheckedChange={(checked) => handleChange('notifyNewManga', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {language === 'ar' ? 'إشعارات عند إضافة فصول جديدة للمانجا المفضلة' : 'Notifications when new chapters are added to your favorite manga'}
                  </p>
                </div>
                <Switch
                  id="notifyNewChapter"
                  checked={settings.notifyNewChapter}
                  onCheckedChange={(checked) => handleChange('notifyNewChapter', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {language === 'ar' ? 'إشعارات عند الرد على تعليقاتك' : 'Notifications when someone replies to your comments'}
                  </p>
                </div>
                <Switch
                  id="notifyComments"
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {language === 'ar' ? 'إشعارات مهمة من النظام وتحديثات الموقع' : 'Important system notifications and site updates'}
                  </p>
                </div>
                <Switch
                  id="notifySystem"
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="system">{language === 'ar' ? 'تلقائي (حسب النظام)' : 'System'}</option>
                </select>
              </div>
        ...
        <TabsContent value="security" className="space-y-6">
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {language === 'ar' ? 'تغيير كلمة المرور الخاصة بك بشكل دوري يحافظ على أمان حسابك' : 'Changing your password regularly helps keep your account secure'}
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {language === 'ar' ? 'حذف حسابك سيؤدي إلى إزالة جميع بياناتك نهائيًا من الموقع' : 'Deleting your account will permanently remove all your data from our site'}
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-lg font-medium">
                  {language === 'ar' ? 'تسجيل الخروج من جميع الأجهزة' : 'Sign Out From All Devices'}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {language === 'ar' ? 'سيتم تسجيل خروجك من جميع الأجهزة التي قمت بتسجيل الدخول إليها' : 'You will be signed out from all devices you are currently logged into'}
                </p>
              </div>
