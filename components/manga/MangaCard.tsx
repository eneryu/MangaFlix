...
const MangaCard = ({ id, title, coverImage, rating = 0, status = "", authorName = "", type, chapterCount, currentChapter }: MangaCardProps) => {
  return (
    <div className="group relative rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all bg-card">
      ...
      <div className="p-3">
        ...
        <p className="text-xs text-muted-foreground truncate mb-2">{authorName}</p>
