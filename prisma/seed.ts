  ...
  const mangaList = [
    {
      ...
      coverImage:
        "https://images.unsplash.com/photo-1617074172293-a0f2837f10b3?q=80&w=600",
      author: {
    ...
    },
    {
      title: "عالم الأبطال",
      description:
        "في عالم مليء بالأشخاص ذوي القدرات الخارقة، يسعى شاب عادي ليصبح بطلاً",
      status: Status.ONGOING,
      coverImage:
    ...
    },
    {
      ...
      status: Status.ONGOING,
      coverImage:
        "https://images.unsplash.com/photo-1604152135912-04a022e73f35?q=80&w=600",
      author: {
        connect: { id: author.id },
      },
      genres: {
    ...
    },
    {
      ...
      status: Status.ONGOING,
      coverImage:
        "https://images.unsplash.com/photo-1561948955-570b270e7c36?q=80&w=600",
      author: {
        connect: { id: author.id },
      },
      genres: {
    ...
    },
    {
      ...
      status: Status.COMPLETED,
      coverImage:
        "https://images.unsplash.com/photo-1532347922424-c84d79eca929?q=80&w=600",
      author: {
        connect: { id: author.id },
      },
      genres: {
    ...
    },
    {
      ...
      status: Status.ONGOING,
      coverImage:
        "https://images.unsplash.com/photo-1582921597893-f834b3de4e28?q=80&w=600",
      author: {
        connect: { id: author.id },
      },
      genres: {
